...
<html lang="en-US">
  ...
  <body>
    <header>
      <h1><a href="article.php">Super Legit News</a></h1>
      <h2><a href="article.php">Where fake news are born!</a></h2>
      <div id="signup">
    ...
    <nav id="menu">
      ...
      <ul>
        <li><a href="article.php">Local</a></li>
        <li><a href="article.php">World</a></li>
        <li><a href="article.php">Politics</a></li>
        <li><a href="article.php">Sports</a></li>
        <li><a href="article.php">Science</a></li>
        <li><a href="article.php">Weather</a></li>
      </ul>
    </nav>
    <aside id="related">
      <article>
